import { Disclosure, Menu, Transition } from "solid-headless";
            ...
            <div class="-mr-2 flex md:hidden">
              ...
              >
                ...
                {menuOpen() ? (
                  ...
                  <Icon class="block h-6 w-6" aria-hidden="true" chevronDown />
                )}
              </button>
            </div>
          </div>
      ...
      <main>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
          ...
          <div class="px-4 py-6 sm:px-0">
            <div class="h-96 rounded-lg border-4 border-dashed border-gray-200">HELLO WORLD</div>
          </div>
          {/* /End replace */}
        </div>
      </main>
