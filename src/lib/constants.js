...
export const DEFAULT_CUSTOMER_AVAILABILITY = [
  ...
  { customer_id: "", day: 2, time: "11:00" },
  { customer_id: "", day: 2, time: "11:30" },
  { customer_id: "", day: 3, time: "14:30" },
  { customer_id: "", day: 3, time: "13:00" },
  { customer_id: "", day: 3, time: "13:30" },
  { customer_id: "", day: 3, time: "14:00" },
  { customer_id: "", day: 4, time: "15:30" },
  { customer_id: "", day: 3, time: "16:00" },
  { customer_id: "", day: 5, time: "09:00" },
  { customer_id: "", day: 5, time: "09:30" },
  { customer_id: "", day: 5, time: "10:00" },
  { customer_id: "", day: 5, time: "10:30" },
  { customer_id: "", day: 5, time: "11:00" },
];
...
export const LAMBDA_URL = () => {
  return import.meta.env.DEV ? `http://localhost:9999/.netlify/functions` : `https://paulin-contrib--lambent-vacherin-760b11.netlify.app/.netlify/functions`
}
